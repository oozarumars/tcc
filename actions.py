...
## Neste programa é configurado todas as funcionadades dos widgets da interface gráfica.
...
class MainWindow(QMainWindow):
    #Criação das funções a serem utilizadas nos widgets
    ...
    def executar(self): #executa os outros módulos
        try:
